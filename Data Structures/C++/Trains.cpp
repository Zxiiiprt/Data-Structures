...
class MyQueue
{
    ...
    bool pop() {
        //If data points to Null (If your Q is empty)
        if(data == NULL) return false; //Nothing for us to POP
    ...
    T front() {
        ...
        if(numElements > 0) return data[0];
    ...
    void printTrack(MyQueue<T> track) {
        for(int i = 0; i < track.size(); i++) {
            if(track.size() == 0 || track.data == NULL) break;
            ...
            for(int i = 0; i < len1; i++) {
                ...
                if(i == 0) {
                    ...
                    if(track3.front() < track1.front()) {
                        ...
                        /*
                        int l1 = track1.size();
                        //Print T1 after Rearranging
                        std::cout << "Track1 after Rearranging: ";
                        printTrack(track1, l1);
                        int l2 = track2.size();
                        //Print T2 after Rearranging
                        std::cout << "Track2 after Rearranging: ";
                        printTrack(track2, l2);
                        int l3 = track3.size();
                        //Print T3 after Rearranging
                        std::cout << "Track3 after Rearranging: ";
                        printTrack(track3, l3);
                        */
                    }
                    //If the Front of T3 > front of T1
                    ...
                    else std::cout << "Some really weird ERROR is happening...\n";
                }
            }
    ...
    while(value != 5){
        ...
        switch(value) {
            ...
            case 1: {
                ...
                std::cin >> inpstring;
                //inpstring = getChoice();
                for(int i = 0; i < strlen(inpstring); i++) q1.push(inpstring[i]);
                q1.Rearrange(); 
                int sz1 = q1.size();
